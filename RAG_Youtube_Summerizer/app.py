...
def main():
    ...
    if page == "Video Processing":
        ...
        video_url = st.text_input("Enter video URL:",label_visibility="collapsed")
        ...
        if not st.session_state.tasks_completed:
            ...
            # Create a layout with text input and button
            query = st.text_input("Enter your question about the video:", key="query_input",label_visibility="collapsed")
            ...
            st.markdown(
                '''
                <script>
                const input = window.parent.document.querySelector('[data-testid="query_input"]');
                input.addEventListener('keydown', function(e) {
                    if (e.key === 'Enter') {
                        const searchButton = window.parent.document.querySelector('[data-testid="search_button"] button');
                        searchButton.click();
                    }
                });
                </script>
